...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		int status=cusdao.saveCustomer(new Customer(3,"usha","ap"));
		...
		boolean status1=cusdao.saveCustomerbyPs(new Customer(2,"hari","hyd"));
...
boolean status2=cusdao.UpdateCustomer(new Customer(5,"usha",""));
		if(!status2)
